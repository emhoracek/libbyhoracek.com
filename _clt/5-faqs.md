...
<p class="right"><a href="#faqs">All FAQs</a></p>

### Where will the money come from? {#money}

The community land trust would need income from multiple sources to be sustainable. 

A few sources of revenue are built into the CLT model: 
...
3. **Building sales** - While the CLT retains ownership of the land, it does *sell* the building to new residents.
